...
int main(int argc, char** argv)
{
    	...
    	serverAddress.sin_port = htons(8001); // port  chi bezaram? khobe? vase ssh port 22 mizaram . fix e beza
    	serverAddress.sin_addr.s_addr = inet_addr(argv[1]);//htonl(INADDR_LOOPBACK);//inet_addr("127.0.0.1");
